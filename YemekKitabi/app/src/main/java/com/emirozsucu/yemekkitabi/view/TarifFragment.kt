...
import com.emirozsucu.yemekkitabi.databinding.FragmentTarifBinding
...
class TarifFragment : Fragment() {
    ...
    fun gorselSec(view: View) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            if (ContextCompat.checkSelfPermission(
                ...
                //İzin verilmiş, iizn istememiz gerekiyor.
    ...
    private fun kucukBitmapOlustur(kullanicininSecttigiBitmap: Bitmap, maximumBoyut: Int): Bitmap {
        var width = kullanicininSecttigiBitmap.width
        var height = kullanicininSecttigiBitmap.height
        ...
        return Bitmap.createScaledBitmap(kullanicininSecttigiBitmap, width, height, true)
